					...
					<div class="card">
						<div class="card-header p-2">
							<ul class="nav nav-pills">
								<li class="nav-item"><a class="nav-link " href="/admin/view/user/{{$data['user']->id}}">Basic Information</a></li>
								...
								<li class="nav-item"><a class="nav-link active" href="/admin/view/user/step-4/{{$data['user']->id}}">Portfolio</a></li>
						...
						<div class="card-body">
							<div class="tab-content1">
								<div class="tab-pane" id="settings1">
									<form class="form-horizontal" enctype="multipart/form-data" method="post" action="/admin/update/user/{{$data['user']->id}}">
										{{ csrf_field() }}
										{{ method_field('patch') }}
										<div class="row">
											<div class="col-sm-12">
